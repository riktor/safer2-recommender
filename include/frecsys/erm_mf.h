...
class ERMMFRecommender : public Recommender {
public:
  ERMMFRecommender(int embedding_dim, int num_users, int num_items,
                   float reg, float unobserved_weight, float stdev,
                   float alpha, bool use_cg, float cg_error_tolerance,

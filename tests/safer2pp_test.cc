...
using safer2pp_type = frecsys::SAFER2ppRecommender;
#define RECSYS_NAME "frecsys::SAFER2ppRecommender"

class SAFER2ppTest : public ::testing::Test {
protected:
  void SetUp() override {
...
class SAFER2ppSNRTest : public ::testing::Test {
protected:
  void SetUp() override {
    google::InstallFailureSignalHandler();
...
class SAFER2ppEPTest : public ::testing::Test {
protected:
  void SetUp() override {
    google::InstallFailureSignalHandler();
...
TEST_F(SAFER2ppTest, TEST_SAFER2pp_ML1M) {
  google::InstallFailureSignalHandler();
  ...
  frecsys::SAFER2ppRecommender *recommender;
  recommender = new frecsys::SAFER2ppRecommender(
      ...
      std::atoi(flags_.at("use_snr").c_str()), 0.1, 4);
  ((frecsys::SAFER2ppRecommender *)recommender)
...
TEST_F(SAFER2ppSNRTest, TEST_SAFER2pp_ML1M) {
  google::InstallFailureSignalHandler();
  ...
  recommender = new frecsys::SAFER2ppRecommender(
      ...
      std::atof(flags_.at("sampling_ratio").c_str()), 4);
  ((frecsys::SAFER2ppRecommender *)recommender)
      ->SetPrintTrainStats(std::atoi(flags_.at("print_train_stats").c_str()));
...
TEST_F(SAFER2ppEPTest, TEST_SAFER2pp_ML1M) {
  google::InstallFailureSignalHandler();

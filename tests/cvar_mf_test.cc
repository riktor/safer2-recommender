...
using cvar_mf_type = frecsys::CVaRMFRecommender;
#define RECSYS_NAME "frecsys::CVaRMFRecommender"

class CVARMFTest : public ::testing::Test {
protected:
  void SetUp() override {
    google::InstallFailureSignalHandler();

    flags_["embedding_dim"] = "8";
    flags_["unobserved_weight"] = "0.008";
...
TEST_F(CVARMFTest, TEST_CVARMF_ML1M) {
  google::InstallFailureSignalHandler();
  ...
  frecsys::CVaRMFRecommender *recommender;
  recommender = new frecsys::CVaRMFRecommender(
      ...
      std::atof(flags_.at("stepsize").c_str()),

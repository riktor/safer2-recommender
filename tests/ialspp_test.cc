...
using ialspp_type = frecsys::IALSppRecommender;
#define RECSYS_NAME "frecsys::IALSppRecommender"

class IALSppTest : public ::testing::Test {
protected:
  void SetUp() override {
...
TEST_F(IALSppTest, TEST_ials_ML1M) {
  google::InstallFailureSignalHandler();
  ...
  frecsys::IALSppRecommender *recommender;
  recommender = new frecsys::IALSppRecommender(
      ...
      std::atof(flags_.at("alpha").c_str()), 4);
  ((frecsys::IALSppRecommender *)recommender)
